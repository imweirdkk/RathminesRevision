...
- Each neural network has many processing elements similar to 'neurons', with several connections between them
- The connections between neurons give a distributive illustration of the data being processed